  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-sand items-center justify-center py-24 px-6">
      <div className="bg-cream border border-earth/10 p-8 md:p-12 w-full max-w-md shadow-sm">
        <h1 className="text-3xl font-serif text-earth uppercase tracking-widest text-center mb-2">{t("register")}</h1>
        <p className="text-center text-earth/70 text-sm mb-8">{t("registerSubtitle")}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <Input type="text" name="firstName" placeholder={t("firstNamePlaceholder")} required disabled={loading} />
            <Input type="text" name="lastName" placeholder={t("lastNamePlaceholder")} required disabled={loading} />
            <Input type="email" name="email" placeholder={t("emailPlaceholder")} required disabled={loading} />
            <Input type="tel" name="phone" placeholder={t("phonePlaceholder")} disabled={loading} />
            <Input type="password" name="password" placeholder={t("passwordPlaceholder")} required disabled={loading} />
          </div>

          <Button type="submit" className="w-full" disabled={loading}>
            {loading ? t("creatingBtn") : t("createAccount")}
          </Button>
        </form>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase tracking-widest">
            <span className="bg-cream px-4 text-earth/50">{t("orContinueWith")}</span>
          </div>
        </div>
