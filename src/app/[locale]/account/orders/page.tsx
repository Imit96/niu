  ...
  return (
    <div className="bg-cream border border-earth/10 p-8 md:p-12 space-y-12 shadow-sm min-h-[500px]">
      <div className="border-b border-earth/20 pb-4">
        <h1 className="text-2xl font-serif text-earth uppercase tracking-widest">{t("ordersTitle")}</h1>
        <p className="text-earth/70 mt-2 text-sm">{t("ordersSubtitle")}</p>
      </div>

      {orders.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 border border-dashed border-earth/20 bg-sand/30">
          <p className="text-earth font-serif text-lg mb-4">{t("noOrders")}</p>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-earth/20 text-xs uppercase tracking-widest text-earth/60">
                <th className="py-4 font-medium">{t("orderId")}</th>
                <th className="py-4 font-medium">{t("date")}</th>
                <th className="py-4 font-medium">{t("status")}</th>
                <th className="py-4 font-medium text-right">{t("totalLabel")}</th>
              </tr>
            </thead>
