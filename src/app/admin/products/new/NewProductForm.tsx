        ...
        <div className="space-y-4">
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4 p-4 border border-earth/10 bg-stone/20">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      name="textureScent"
                      rows={4}
                      defaultValue="Earthy, slightly gritty paste that transforms into a soft, non-foaming cream. Scented with vetiver and raw clay."
                      className="flex w-full rounded-none border border-earth/20 bg-sand px-4 py-3 text-sm text-earth shadow-sm placeholder:text-earth/40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-earth disabled:cursor-not-allowed disabled:opacity-50"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4 p-4 border border-earth/10 bg-stone/20">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      defaultValue="Cultural Inspiration"
                      className="bg-sand border-earth/20 focus-visible:border-bronze" 
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      rows={4}
                      defaultValue="Inspired by the purifying regimens of the continent, where the earth itself is used to draw out impurities and restore balance."
                      className="flex w-full rounded-none border border-earth/20 bg-sand px-4 py-3 text-sm text-earth shadow-sm placeholder:text-earth/40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-earth disabled:cursor-not-allowed disabled:opacity-50"
                    />
                  </div>
                </div>
            ...
            <div className="space-y-2">
              ...
              <FocalPointPicker name="performanceMediaPosition" label="Performance Media Focal Point" />
            </div>
