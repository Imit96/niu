        ...
        <form onSubmit={handleSaveProfile} className="space-y-8 max-w-xl">
          <div className="grid grid-cols-1 space-y-6">
            <div className="space-y-2">
               ...
               <Input name="name" defaultValue={session?.user?.name || ""} required className="bg-sand border-earth/20" />
            </div>
            <div className="space-y-2">
               ...
               <Input name="email" defaultValue={session?.user?.email || ""} disabled className="bg-sand/50 border-earth/10 text-earth/50" />
            </div>
